...
public class AccountPageLocators extends ActionEngine {
	...
	public static By signUpDataValidationAlert = By
			.xpath("//UIAStaticText[@name='Sorry!']");
	...
	public static By upcomingBookings = By
			.xpath("//UIATableGroup[@name='UPCOMING BOOKINGS']");
	public static By bookedCity = By
			.xpath("//UIAStaticText[@name='#']");
	public static By totalBookingCost = By.
			xpath("//UIAStaticText[@name='#']");
	...
	public static By connectWithFaceBookButton = By
