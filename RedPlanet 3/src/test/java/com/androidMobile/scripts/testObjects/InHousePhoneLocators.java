...
public class InHousePhoneLocators {
	...
	public static String noButtonToDial = ("//*[@text='#'][@resource-id='android.widget.Button']");
	...
	public static By frontDeskButtonToCall = By.xpath("//*[[@resource-id='com.redplanethotels.staging:id/phone_bt_frontdesk']");
